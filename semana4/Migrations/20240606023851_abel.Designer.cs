...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PermisoRol", b =>
                {
                    ...
                    b.Property<int>("IdrolsId")
                        .HasColumnType("int");

                    b.HasKey("IdpermisosIdpermiso", "IdrolsId");
            ...
            modelBuilder.Entity("semana4.Models.Permiso", b =>
                {
            ...
            modelBuilder.Entity("semana4.Models.Rol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PermisoRol", b =>
                {
                    b.HasOne("semana4.Models.Permiso", null)
                        .WithMany()
                        .HasForeignKey("IdpermisosIdpermiso")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("semana4.Models.Rol", null)
                        .WithMany()
                        .HasForeignKey("IdrolsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("semana4.Models.Usuario", b =>
                {
                    b.HasOne("semana4.Models.Rol", "IdrolNavigation")
                        .WithMany("Usuarios")
