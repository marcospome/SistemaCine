...
{
    /// <inheritdoc />
    public partial class abel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Rols_IdrolNavigationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdpermisosIdpermiso = table.Column<int>(type: "int", nullable: false),
                    IdrolsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PermisoRol", x => new { x.IdpermisosIdpermiso, x.IdrolsId });
                    table.ForeignKey(
                        name: "FK_PermisoRol_Permisos_IdpermisosIdpermiso",
                        column: x => x.IdpermisosIdpermiso,
                        principalTable: "Permisos",
                        principalColumn: "Idpermiso",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PermisoRol_Rols_IdrolsId",
                        column: x => x.IdrolsId,
                        principalTable: "Rols",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_IdrolNavigationId",
                table: "AspNetUsers",
